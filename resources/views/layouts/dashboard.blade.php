  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
      <a href="{{ route('home') }}" class="brand-link">
        <img src="{{ asset('img/logo-sidebar.png') }}" alt="Logo" class="brand-image elevation-3">
        <span class="brand-text font-weight-light">Sendgrid Hook</span>
      </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar nav-child-indent flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ route('sender-identity.index') }}" class="nav-link {{ (request()->is('sender-identity*')) ? 'active' : '' }}">
                <i class="fa-solid fa-share nav-icon"></i>
                <p>Sender</p>
              </a>
            </li>

            <li class="nav-item has-treeview {{ (request()->is('data-event/*')) ? 'menu-open' : '' }}">
              <a href="#" class="nav-link {{ (request()->is('data-event/*')) ? 'active' : '' }}">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{ route('get.delivery-event') }}" class="nav-link {{ (request()->is('data-event/delivery*')) ? 'active' : '' }}">
